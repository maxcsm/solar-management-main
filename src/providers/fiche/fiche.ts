	...
	public fiches = [
		{
			...
			contents: [
				{
					...
					content: `
          1. En quoi s’inscrit –elle dans le projet de l’entreprise ?<br>
          ...
          `,
				...
				},
				{
					...
					content: `
          1. Saisir une opportunité en s’appuyant sur ses forces<br>
          2. Contrer une menace en s’appuyant sur ses forces<br>
          3. Réduire ses faiblesses en s’appuyant sur ses forces<br>
          `,
				},
				{
					title:
		...
		},
		{
			...
			how: `
      1. Expliquer le contexte et les enjeux qui en découlent<br>
      2. Annoncer les objectifs à atteindre (avec indicateurs et délais)<br>
      3. Annoncer les difficultés à venir<br>
      4. Expliquer les moyens donnés<br>
      5. Concentrer les collaborateurs sur quelques priorités<br>
      6. Rappeler les valeurs et les comportements attendus pour réussir<br>
			...
			contents: [
				{
					...
					content: `
          1. Date de l’annonce<br>
          2. Période d’entretiens individuels<br>
          3. Date du changement effectif<br>
          4. Dates des formations ou groupes de travail<br>
          5. Dates des points intermédiaires<br>
          `,
				},
				{
				...
				},
				{
					...
					content: `
          1. En alignant le changement avec les valeurs et le projet de l’entreprise<br>
          2. En faisant un bilan positif du passé<br>
          3. En expliquant ce qui ne change pas<br>
          4. En expliquant les gains associés au changement<br>
          5. En anticipant les résistances de collaborateurs<br>
          `,
				},
				{
		...
		},
		{
			...
			contents: [
				...
				},
				{
					...
					content: `
          1. Valoriser la première proposition<br>
          2. Écrire toutes les propositions<br>
          3. Écrire avec les mots exacts proposés<br>
          `,
				},
				{
					title:
      ...
      `,
		...
		},
		{
			...
			why_img: 'success.jpg',
			how: `
      1. Rappeler les enjeux et les objectifs<br>
      2. Raconter la période écoulée et les difficultés rencontrées<br>
      3. Citer des services contributeurs<br>
      4. Annoncer les résultats positifs<br>
      5. Féliciter et donner un enseignement à l’origine du succès<br>
      ...
      `,
		...
		},
		{
			...
			why_img: 'team.jpg',
			how: `
      1. Rappeler les objectifs et les enjeux<br>
      2. Annoncer les résultats<br>
      3. Mentionner les difficultés rencontrées<br>
      4. Citer les points positifs : efforts, progrès<br>
      5. Présenter une analyse de l’échec en distinguant les causes externes des causes internes<br>
      6. Annoncer les actions correctives décidées<br>
		...
		},
		{
			...
			contents: [
				...
				},
				{
					...
					content: `
          1. Faire le point sur les objectifs : analyse des écarts (raisons du succès ou de l’échec)<br>
          2. La grille de compétence : Ecouter d’abord la vision du collaborateur : points forts puis points de progrès<br>
          3. Reprendre ensuite :<br>
            1/ Les points positifs<br>
            2/ Les points d’amélioration : noter les progrès cités par le collaborateur<br>
            3/ Les points de désaccord : reformuler la part de vrai dans ses propos (les progrès réalisés) avant d’ajouter ses arguments<br>
          `,
				},
				{
      ...
      7. Expliquer les étapes suivantes ou clôturer l’entretien<br>`,
		...
		},
		{
			...
			how: `
      1. Organiser une réunion avec l’équipe<br>
      2. Rappeler l’importance de partager des règles pour le fonctionnement d’une équipe<br>
      3. Faire lister les comportements gagnants dans le travail<br>
      4. Faire lister les comportements gênants dans le travail<br>
      5. Faire des rapprochements et choisir les comportements les plus importants<br>
      ...
      `,
		...
		},
		{
			...
			how: `
      1. Expliquer sa demande en donnant du sens via les conséquences pour l’entreprise, le client<br>
      2. Ecouter les contraintes de l’autre, creuser pour bien comprendre<br>
      3. Reformuler les contraintes de l’autre en étant factuel<br>
      4. Exprimer sa compréhension de ses contraintes et rappeler ses propres enjeux (si possible en les connectant aux siens)<br>
      5. Lui demander ce qu’il propose ou lui proposer une solution<br>
